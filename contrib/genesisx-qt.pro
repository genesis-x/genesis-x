...
RESOURCES += src/qt/genesisx.qrc src/qt/genesisx_locale.qrc

TRANSLATIONS += src/qt/locale/genesisx_bg.ts \
                src/qt/locale/genesisx_de.ts \
                src/qt/locale/genesisx_en.ts \
                src/qt/locale/genesisx_es.ts \
                src/qt/locale/genesisx_fi.ts \
                src/qt/locale/genesisx_fr.ts \
                src/qt/locale/genesisx_it.ts \
                src/qt/locale/genesisx_ja.ts \
                src/qt/locale/genesisx_pl.ts \
                src/qt/locale/genesisx_pt.ts \
                src/qt/locale/genesisx_ru.ts \
                src/qt/locale/genesisx_sk.ts \
                src/qt/locale/genesisx_sv.ts \
                src/qt/locale/genesisx_vi.ts \
                src/qt/locale/genesisx_zh_CN.ts \
                src/qt/locale/genesisx_zh_TW.ts
