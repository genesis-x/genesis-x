...
In order to support loading of multiple wallets in genesisx-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is genesisx.cpp.
...
Changes to genesisx.cpp
----------------------
genesisx.cpp is the entry point into genesisx-qt, and as such, will require some minor modifications to provide hooks for
