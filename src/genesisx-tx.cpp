...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("GenesisX Core genesisx-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  genesisx-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded genesisx transaction") + "\n" +
                               "  genesisx-tx [options] -create [commands]   " + _("Create hex-encoded genesisx transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded genesisx transaction
