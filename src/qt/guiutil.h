...
/** Utility functions used by the GenesisX Qt UI.
 */
namespace GUIUtil
{
...
// Render GenesisX addresses in monospace font
...
// Parse "genesisx:" URI into recipient object, return true on successful parsing
