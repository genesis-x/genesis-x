...
public:
    ...
    void setZGenesisXControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzXGS_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzXGS_clicked();
    void on_pushButtonZGenesisXControl_clicked();
