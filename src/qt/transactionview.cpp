                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received GenesisX from zGenesisX"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zGenesisX"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zGenesisX));
