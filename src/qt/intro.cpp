...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("GenesisX Core"),
     ...
     * override -datadir in the genesisx.conf file in the default data directory
     * (to be consistent with genesisxd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
