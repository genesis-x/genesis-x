Contributing to GenesisX Core
============================

The GenesisX Core project operates an open contributor model where anyone is
...
The following applies to code changes to the GenesisX Core project, and is not to be
confused with overall GenesisX Network Protocol consensus changes.

Whether a pull request is merged into GenesisX Core rests with the project merge
...
Patches that change GenesisX consensus rules are considerably more involved than
...
Where a patch set proposes to change the GenesisX consensus, it must have been
...
The project leader is the release manager for each GenesisX Core release.
